            ...
            if prop.startswith ('snapinfo_3bonelimb'):
                ...
                if mode == 'IK_to_FK':           
                    ...
                    def calculate_pole_target_location (b1, b2, b3, pole_target_distance):
                        ...
                        midpoint = ( pbones[b1].matrix.translation + pbones[b3].matrix.translation ) / 2
                    ...
                    # pole_target
                    calc_pole_pos = calculate_pole_target_location (fk_b1, fk_b2, fk_b3, pole_target_distance)
